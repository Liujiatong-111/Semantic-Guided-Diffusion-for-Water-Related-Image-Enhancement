...
def RGB2YCrCb_Tensor(rgb_image):
    b, c, w, h = rgb_image.shape
    rgb_image = rgb_image.reshape(c, b, w, h)
    rgb_image_y, cb, cr = RGB2YCrCb(rgb_image)
    rgb_image_y = rgb_image_y.reshape(b, 1, w, h)
    return rgb_image_y
